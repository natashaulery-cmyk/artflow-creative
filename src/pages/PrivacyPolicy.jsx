    ...
    <main className="min-h-screen bg-background text-foreground px-5 py-10">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="space-y-7 text-sm leading-7">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-2">Disconnecting Google</h2>
            <p>
              You may stop using a connected Google service by disconnecting it in the app when that option is available, or by removing Art Flow Creative access from your Google Account permissions. Disconnecting a service stops future access through that connection but may not automatically delete information already imported into your Art Flow Creative account.
            </p>
          </section>
